...
describe('Searching movies', () => {
  ...
  beforeEach(() => {
    ...
    contrusctorPresenter();
  });
  describe('When query is not empity', () => {
    ...
    it('should show the name of th movie found  by Fav Movie', (done) => {
      document.getElementById('movies').addEventListener('movies:updated', () => {
        const movieTitles = document.querySelectorAll('.movie__title');
  ...
  describe('When no fav movies could be found', () => {
